...
class GRPOConfig(trl.GRPOConfig):
    ...
    labeling_host: str = field(
        default="0.0.0.0",
        metadata={"help": "Host of the vLLM server to connect to."},
    )
    labeling_port: int = field(
        default=5000,
        metadata={"help": "Port of the vLLM server to connect to."},
    )
    labeling_tokenizer: str = field(
        default="model/Reflection_Model",
        metadata={"help": "Port of the vLLM server to connect to."},
    )
    group_port: int = field(
        default=51216,
        metadata={"help": "Port of the Group server to connect to."},
    )
    custom_truncate: bool = field(
        default=True,
        metadata={"help": "Port of the vLLM server to connect to."},
    )
    custom_loss: int = field(
        default=0,
        metadata={"help": "Port of the vLLM server to connect to."},
    )
